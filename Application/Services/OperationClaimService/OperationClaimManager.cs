...
public class OperationClaimManager : IOperationClaimService
{
    ...
    public async Task<Paginate<OperationClaim>?> GetListAsync(Expression<Func<OperationClaim, bool>>? predicate = null,
        ...
        CancellationToken cancellationToken = default)
    {
        Paginate<OperationClaim> operationClaimList = await _operationClaimRepository.GetListAsync(predicate,
            orderBy,
            include,
            index,
            size,
