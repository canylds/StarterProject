...
public class UserOperationClaimManager : IUserOperationClaimService
{
    ...
    public async Task<Paginate<UserOperationClaim>?> GetListAsync(Expression<Func<UserOperationClaim, bool>>? predicate = null,
        ...
        CancellationToken cancellationToken = default)
    {
        Paginate<UserOperationClaim> userUserOperationClaimList = await _userUserOperationClaimRepository.GetListAsync(predicate,
            orderBy,
            include,
            index,
            size,
